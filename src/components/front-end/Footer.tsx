...
Your e-commerce site is a user-friendly platform designed to offer a seamless shopping experience. It features a wide range of products, a clean and intuitive interface, and a secure checkout process. Customers can easily browse, filter, and purchase items, with a focus on convenience and efficiency. The site is optimized for both desktop and mobile devices, ensuring accessibility on the go.
        </p>
    ...
    <div className="mt-16 border-t border-gray-100 pt-8">
      <p className="text-center text-xs/relaxed text-gray-500">
        ...
        Created with
        <a href="#" className="text-gray-700 underline transition hover:text-gray-700/75"> Ranitha Roosanda</a>
        and
